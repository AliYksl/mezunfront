...
class OgrenciBilgilerim extends Component {
  ...
  componentDidMount() {
      axios.get(API_URL + "/api/users")
          .then(res => {
              const user = res.data.data.filter(x =>
                  x.email === localStorage.getItem('email'))[0];
              if (user != null) {
                  this.setState({
                      ...
                      sector: user.sector,
                      schoolStartDate: user.schoolStartDate,
                      schoolGraduationDate: user.schoolGraduationDate,
                      place: user.place,
                      ...
                      <div>
                        ...
                        <div className="ui inverted segment">
                          ...
                          <div className="ui icon input">
                            ...
                            <a href="/ogrencigiris" className="ui item" onClick={()=>{
  ...
  <div className="card">
    <div className="content">
      ...
      <div className="description" >
        Ülke: {this.state.country}
      </div>
      <div className="description">
        Yaşadığı Şehir: {this.state.place}
      </div>
      <div className="description">
        T.C Kimlik No: {this.state.identificationNumber}
      </div>
      <div className="description">
        Okul Numarası: {this.state.studentNumber}
      </div>
      <div className="description">
        Akedemik Birim: {this.state.faculty}
      </div>
      <div className="description">
        Eğitim Başlangıç Yılı: {this.state.schoolStartDate}
      </div>
      <div className="description">
        Eğitim Bitirme Yılı: {this.state.schoolGraduationDate}
      </div>
      <div className="description">
        Cep No: {this.state.phoneNumber}
      </div>
      <div className="description">
       E-mail: {this.state.email}
      </div>
      <div className="description">
        Sektör: {this.state.sector}
      </div>
      <div className="description">
        Pozisyon: {this.state.position}
      </div>
    </div>
...
<h4 style={{color:'red'}}>*Bilgilerinizi değiştirdikten sonra güncelle butonuna tıklamayı unutmayın !</h4>
                    ...
                    <div>
                     ...
                     <button className="ui primary button"
                        onClick={()=>{
                            axios.put(API_URL + "/api/auth/updatedetails", {
...
export default OgrenciBilgilerim;
