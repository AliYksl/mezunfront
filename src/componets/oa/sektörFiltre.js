...
class SektörFiltre extends Component {
    ...
    return(
      <div>
        ...
        <div className="ui inverted vertical menu" align="center"style={{float:'left'}}>
                ...
                <a href="SektörFiltre" className="active item">Sektöre Göre Filtrele </a>
            ...
            {this.state.users
                        .filter(user => user.sector.includes(this.state.inpt))
                         .map(veriler => (
