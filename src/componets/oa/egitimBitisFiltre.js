...
class EgitimBitisFiltre extends Component {
    ...
    return(
      <div>
        ...
        <div className="ui inverted vertical menu" align="center"style={{float:'left'}}>
                ...
                <a href="EgitimBitisFiltre" className="active item">Eğitim Bitirme Yılına Göre Filtrele </a>
            ...
            {this.state.users
                        .filter(user => user.schoolGraduationDate.includes(this.state.inpt))
                         .map(veriler => (
...
export default EgitimBitisFiltre;
