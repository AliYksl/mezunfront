...
class AkedemikBirimFiltre extends Component {
    ...
    return(
      <div>
        ...
        <div className="ui inverted vertical menu" align="center"style={{float:'left'}}>
                ...
                <a href="AkedemikBirimFiltre" className="active item">Akedemik Birime Göre Filtrele </a>
            ...
            {this.state.users
                        .filter(user => user.faculty.includes(this.state.inpt))
                         .map(veriler => (
...
export default AkedemikBirimFiltre;
