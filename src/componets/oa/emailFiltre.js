...
class EmailFiltre extends Component {
    ...
    return(
      <div>
        ...
        <div className="ui inverted vertical menu" align="center"style={{float:'left'}}>
                ...
                <a href="EmailFiltre" className="active item">E-mail'e Göre Filtrele </a>
            ...
            {this.state.users
                        .filter(user => user.email.includes(this.state.inpt))
                         .map(veriler => (
