...
class OkulNoFiltre extends Component {
    ...
    return(
      <div>
        ...
        <div className="ui inverted vertical menu" align="center"style={{float:'left'}}>
                ...
                <a href="OkulNoFiltre" className="active item" >Okul Numarasına Göre Filtrele</a>
            ...
            {this.state.users
                        .filter(user => user.studentNumber.includes(this.state.inpt))
                         .map(veriler => (
