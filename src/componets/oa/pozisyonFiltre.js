...
class PozisyonFiltre extends Component {
    ...
    return(
      <div>
        ...
        <div className="ui inverted vertical menu" align="center"style={{float:'left'}}>
                ...
                <a href="PozisyonFiltre" className="active item">Pozisyona Göre Filtrele </a>
                
            </div>

            <div align="center" style={{marginTop:'40px'}}>
            {this.state.users
                        .filter(user => user.position.includes(this.state.inpt))
                         .map(veriler => (
