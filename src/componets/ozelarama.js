...
class OzelArama extends Component {
   ...
   // console.log(this.state)
    ...
    return(
      <div>
        ...
        <div >
        <div className="ui inverted vertical menu" style={{float:'left'}}>
                <a href="OzelArama" className="active item">TC Kimlik No Göre Filtrele </a>
                ...
                <a href="EgitimBaslangıcFiltre" className="item">Eğitim Başlama Yılına Göre Filtrele</a>
            ...
            {this.state.users
                        .filter(user => user.identificationNumber.includes(this.state.inpt))
                         .map(veriler => (
